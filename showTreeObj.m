function showTreeObj(tree, listofnames)
%
% Displays the tree created with text:
%
%  showtree([2 0 2],{'a','b','c'})


trimtreeplot(tree);
hold on
[x,y,h,s] = trimtreelayout(tree);

for n = 1:length(x)
    plot(x(n), y(n), 'o', 'markersize', 16, 'MarkerFaceColor', 'g');
    h = text(x(n), y(n), listofnames{n});
    set (h, 'fontsize', 12, 'rotation', 270)
end
